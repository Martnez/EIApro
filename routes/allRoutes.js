...
router.get(
  ...
  isAuth,
  clientsControllers.getClientProfile
);
...
router.get(
  "/policyView/:policyId",
  isAuth,
  underwritingControllers.getPolicyView
);
...
router.get(
  "/vehicle-view/:vehicleId",
  isAuth,
  vehicleControllers.getVehicleView
);
...
router.get(
  ...
  isAuth,
  adminAuth,
  homeControllers.getUserProfile
);

router.post(
  "/user-profile/:userId",
  isAuth,
  homeControllers.getUserProfileEdit
);
...
router.get(
  ...
  isAuth,
  adminAuth,
  homeControllers.postDeleteUser
);

router.get("/reset-flag/:userId", isAuth, homeControllers.postResetFlag);

router.get("/reset", homeControllers.getResetPage);
...
router.post(
  ...
  body("password")
    ...
    .isAlphanumeric()
    .withMessage(
      "Please ensure that your password is 6-8 character long and contain alphanumeric"
    ),
  homeControllers.postNewPassword
);
router.post(
  "/newPassword",
  body("password")
...
router.post(
  ...
  isAuth,
  claimsControllers.postClaimAction
);

router.get(
  "/deleteAction/:claimActionId/:claimId",
  isAuth,
  claimsControllers.deleteAction
);
...
router.get(
  ...
  isAuth,
  clientsControllers.getdeleteClient
);
router.get(
  "/delete-policy/:clientId",
  isAuth,
  underwritingControllers.getdeletePolicy
);
...
router.get(
  "/insurancePay/:policyId",
  isAuth,
  creditControllers.getInsurancePay
);
...
router.post(
  "/insurancePay/:policyId",
  isAuth,
  creditControllers.postInsurancePay
);

router.post("/creditPay/:policyId", isAuth, creditControllers.postCreditPay);
router.get(
  "/pay_delete/:payId/:policyId",
  isAuth,
  creditControllers.getPayDelete
);
router.get(
  "/credit_delete/:creditId/:policyId",
  isAuth,
  creditControllers.getCollectDelete
);
